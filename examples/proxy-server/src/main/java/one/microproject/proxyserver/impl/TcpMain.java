    ...
    public void run() {
        ...
        try {
            ...
            while (active) {
                ...
                TcpDataForwarder forwardPipe = new TcpDataForwarder(" -> ", clientSocket.getInputStream(), socket.getOutputStream());
                TcpDataForwarder reversePipe = new TcpDataForwarder(" <- ", socket.getInputStream(), clientSocket.getOutputStream());
                TcpActiveConnection activeConnection = new TcpActiveConnection(id, socket, targetHost, targetPort, forwardPipe, reversePipe, connectionRegistry);
